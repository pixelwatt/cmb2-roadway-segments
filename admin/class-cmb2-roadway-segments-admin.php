 ...
 * @package Cmb2_Roadway_Segments
 * @subpackage Cmb2_Roadway_Segments/admin
 * @author Rob Clark <hello@pixelwatt.com>
 */
class Cmb2_Roadway_Segments_Admin {
	...
	public function add_action_links( $links ) {
		...
		*/
		$settings_link = array(
			'<a href="' . admin_url( 'options-general.php?page=' . $this->plugin_name ) . '">' . __( 'Settings', 'cmb2-roadway-segments' ) . '</a>',
		);
	...
	public function validate( $input ) {
		...
		$valid['disableroadways'] = ( isset( $input['disableroadways'] ) && ! empty( $input['disableroadways'] ) ) ? 1 : 0;
		$valid['disablegeocoding'] = ( isset( $input['disablegeocoding'] ) && ! empty( $input['disablegeocoding'] ) ) ? 1 : 0;
